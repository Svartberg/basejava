...
<%@ page import="com.urise.webapp.model.HistorySection" %>
    ...
    <table cellpadding="2">
        <c:forEach var="sectionEntry" items="${resume.sections}">
            <jsp:useBean id="sectionEntry"
                         type="java.util.Map.Entry<com.urise.webapp.model.TypeSection, com.urise.webapp.model.Section>"/>
            ...
            <c:choose>
                ...
                <c:when test="${type=='EXPERIENCE' || type=='EDUCATION'}">
                    <c:forEach var="org" items="<%=((HistorySection) section).getHistory()%>">
                        <tr>
                            <td colspan="2">
                                <c:choose>
