            ...
            case "edit":
                ...
                for (TypeSection type : TypeSection.values()) {
                    ...
                    switch (type) {
                        ...
                        case EXPERIENCE:
                        case EDUCATION:
                            HistorySection orgSection = (HistorySection) section;
                            List<Organization> emptyFirstOrganizations = new ArrayList<>();
                            emptyFirstOrganizations.add(Organization.EMPTY);
                            if (orgSection != null) {
                                for (Organization org : orgSection.getHistory()) {
                            ...
                            section = new HistorySection(emptyFirstOrganizations);
                            break;
                    }
            ...
            if (HtmlUtil.isEmpty(value) && values.length < 2) {
                ...
                switch (type) {
                    ...
                    case EXPERIENCE:
                        ...
                        r.setSection(type, new HistorySection(orgs));
                        break;
                }
            }
        }
